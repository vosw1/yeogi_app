...
void main() async {
  await fetchScrapList_test();
  // await fetchScrap_test();
  // await fetchDeleteScrap_test();
}

Future<void> fetchScrapList_test() async {
  await ScrapRepository().fetchScrapList("Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzdGF5Iiwicm9sZSI6InVzZXIiLCJpZCI6MSwiZXhwIjoxNzQ3Mjk3NTk2LCJlbWFpbCI6InNzYXJAbmF0ZS5jb20ifQ.EdrXFTYomi9RuYxwcNdrpRFVF_7s8L6W09bpgsHbWN4BPrTHQYjSO0l3A1ljLDCvX922p2KCN99KjAZIRlf9Rw");
}
