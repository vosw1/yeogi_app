...
| 이름 | 사진 | 역할 | 프론트엔드 | 
|:--:|:--:|:--:|:---------------:|
| 송민경 | <img src="https://avatars.githubusercontent.com/u/153582401?v=4" width="150px"> | 프론트엔드 팀장 | **테이블 설계**</br></br>**화면 디자인**</br>로딩, 로그인, 회원가입, 메인, 숙소 목록, 숙소 상세보기, </br>룸 목록, 룸 상세보기, 예약하기, 결제하기, </br>예약 내역, 예약 상세보기, 검색, 내 주변, 찜</br>마이페이지, 베너, 댓글, 이벤트, FAQ, 고객센터 문의</br></br>**전체적인 뷰 디자인 통일성 맞추기**</br>헤더, 풋터, 글씨체, 로고, 글자 색 등</br></br>**UI 구현**</br>메인, 숙소 목록, 숙소 상세보기, </br>룸 목록, 룸 상세보기, 예약하기, 결제하기, </br>예약 내역, 예약 상세보기, 검색, 내 주변, 네이버 지도 API로 지도 구현, 찜</br>베너, 댓글, 이벤트, FAQ</br></br>**통신**</br> 회원가입, 아이디 중복체크, 로그인, </br>예약 가능 날짜보기, 예약 불가능 날짜 막아놓기, 예약하기, </br>아임포트 API로 결제하기, 예약 목록, 예약 상세보기, 예약 취소,</br>이용후 한달이내 댓글 작성 가능, 예약 취소시 댓글 작성 불가</br></br>**단위 테스트**</br>로그인, 회원가입, 아이디 중복체크, </br>예약 내역, 예약 상세보기, 예약 취소하기, </br>예약 가능날짜보기, 예약 불가능 날짜 막기</br></br>**코드 리팩토링**| 
---
