...
| 이름 | 사진 | 역할 | 프론트엔드 | 
|:--:|:--:|:--:|:---------------:|
| 송민경 | <img src="https://avatars.githubusercontent.com/u/153582401?v=4" width="150px"> | 프론트엔드 팀장 | 테이블 설계<br/>화면 디자인(모든 페이지)<br/>UI 구현(회원가입을 제외한 모든 페이지)<br/>단위 테스트<br/>통신(회원가입, 로그인, 예약 가능 날짜보기, 예약하기, 결제하기, 예약 현황 및 취소)<br/>유효성 검사<br/>코드 리팩토링| 
---
