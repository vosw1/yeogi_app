...
class HomeSaleItem extends StatelessWidget {
  final id;
  final popularList = [
    "p1.png",
    "p2.png",
  ...
  HomeSaleItem({Key? key, required this.id}) : super(key: key);
    ...
    return Column(
      children: [
        ClipRRect(
          ...
          child: Image.asset("assets/images/${popularList[id]}", fit: BoxFit.cover),
        ),
