  ...
  Widget build(BuildContext context) {
    ...
    List<Stay> pensionDataList = [
      ...
      Stay(
        ...
        stayName: "전의 게스트하우스",
        stayInfo: "전의역 근처 마을 주민들이 정성스레 가꾸는 펜션입니다\n여행의 꽃 바비큐 파티를 즐기면서 힐링을 할 수 있습니다",
      ...
      Stay(
        ...
        stayInfo: "조식서비스 / 야외바베큐장 / 개별바베큐 / 객실내 무료 Wi-Fi도심속 휴식공간 모꼬지에 오신 것을 환영합니다!모꼬지는 서울의 심장 종로 혜화동, 대학로 주택가에 자리잡은 한옥 게스트하우스입니다",
      ...
      Stay(
        ...
        starCount: 5.0,
        comment: "사장님께서 친절하셨고 숙소 내부도 매우 청결했습니다. 난방 상태도 좋았습니다. 황리단길에 숙소가 위치해 있어서 주변에서 편히 놀다가 들어올 수 있었고 인근에 편의점 등 같은 편의시설도 있어서 좋았습니다.  ",
      ),
    ];
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: pensionDataList.length,
          itemBuilder: (context, index) {
            final Stay stay = pensionDataList[index];
            return Padding(
