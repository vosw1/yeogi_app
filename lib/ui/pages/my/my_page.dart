...
import 'package:yogi_project/data/models/user.dart'; // 사용자 모델을 임포트합니다.
...
class MyPage extends StatelessWidget {
  final Stay stayData;
  final User userData; // 사용자 정보를 저장하는 변수

  MyPage({required this.stayData, required this.userData}); // 생성자를 통해 사용자 정보를 받아옵니다.
    ...
    return Scaffold(
      body: ListView(
        children: [
          ...
          MyPageAppBar(user: userData), // 사용자 정보를 MyPageAppBar에 전달합니다.
          Divider(
