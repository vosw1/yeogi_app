...
class Move {
  ...
  static String homeAndBillaStayPage = "/stay/homeAndBiila";
...
Map<String, Widget Function(BuildContext)> getRouters() {
  return {
    ...
    Move.myPage: (context) => const MyPage(), // 마이 페이지
    Move.stayPage: (context) => const StayPage(), // 기업(숙서) 페이지
    ...
    Move.saleStayPage: (context) => const SaleStayPage(), // 특가 숙소 페이지
    ...
    Move.roomPage: (context) => const RoomPage(), // 방 페이지
    Move.bookPage: (context) => BookPage(itemData: null,), // 예약 페이지
    Move.payPage: (context) => PayPage(), // 결제 페이지
